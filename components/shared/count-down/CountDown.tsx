...
// Function to calculate a date one month from current date
const getTargetDate = () => {
  const currentDate = new Date();
  // Create a new date by adding one month to the current date
  const targetDate = new Date(currentDate);
  targetDate.setMonth(targetDate.getMonth() + 1);
  return targetDate;
};

// Dynamic target date - one month from now
