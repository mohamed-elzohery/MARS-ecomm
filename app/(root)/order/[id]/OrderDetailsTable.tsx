...
import { formatDateTime, formatOrderId, round2 } from "@/lib/utils";
...
const OrderDetailsTable = ({
      ...
      <Button
        ...
        onClick={() =>
          startTransition(async () => {
            const res = await markProductAsPaid(order.id);
            toast(res.message);
          })
        }
      >
  ...
  const MarkAsDeliveredButton = () => {
    ...
    return (
      <Button
        ...
        onClick={() =>
          startTransition(async () => {
            const res = await markProductAsDelivered(order.id);
            toast(res.message);
          })
        }
      >
  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-3 md:gap-5 gap-6">
